...
# final destination at /srv/birdie:
COPY --from=builder --chown=nobody:nogroup ${APP_PATH} /srv/birdie

# Set the container user to 'nobody':
USER nobody

# Set the RAILS and PORT default values:
ENV HOME=/srv/birdie RAILS_ENV=production PORT=3000
...
ARG IMAGE_NAME="icalialabs/birdie:latest"
LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="birdie" \
      org.label-schema.description="birdie" \
      org.label-schema.vcs-url="https://github.com/icalialabs/birdie.git" \
